...
*(Được viết theo định dạng tiêu chuẩn Agile/User Story: **Given - When - Then (Gherkin format)** làm căn cứ nghiệm thu giữa Đội kiểm thử QA, BA và Khách hàng)*
...
## BƯỚC 13: DANH MỤC VẤN ĐỀ CẦN LÀM RÕ VỚI KHÁCH HÀNG (OPEN ISSUES FOR BA)
...
## BƯỚC 14: KẾ HOẠCH BÀN GIAO 7 TUẦN (7-WEEK GANTT ROADMAP)
...
gantt
    ...
    Chốt SRS, Use Case & Tiêu chí AC    :active,  w1_2, 2026-09-10, 4d
